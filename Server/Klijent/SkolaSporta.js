...
export class SkolaSporta
{
    ...
    crtajFormuDete(formDete)
    {
       ...
       let labImeRod=document.createElement("label");
        ...
        let izbor=this.listaSportova.find(sport=>sport.vrsta==se.options[0].value);
      
        se.onchange=event=>
        {
            let opt=se.options[se.selectedIndex];
            izbor=this.listaSportova.find(sport=>sport.vrsta==opt.value);
